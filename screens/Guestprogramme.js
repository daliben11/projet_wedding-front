...
export default function Guestprogramme({navigation}) {
    const data = [
    ...
    <View style={{flex:1, marginTop: 39}}> 
        ...
        <ImageBackground  source={require('../assets/mariagefondecran.jpg')} style={{flex:1.3}}>
            ...
            <Text style={{color: 'white', fontFamily:'greatvibes', fontSize: 20, marginBottom: 20, mmarginRight: 95, marginLeft: 95}} >23/08/2020</Text>
            ...
            <Text h4 style={{textAlign:'center', fontFamily:'greatvibes',fontWeight: 'bold'}}  style={styles.container}> Hello cher Etienne.
